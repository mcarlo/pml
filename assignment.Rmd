...
### Model 2: _rfTrain2_
I also trained four random forest models on 80% of the training set, using the default parameters from the caret package. I confined each model to a specific device location.
