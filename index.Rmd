...
## 1. Summary
The goal of this task was to predict the manner of exercise (specifically, biceps curls) performed by participants in the Weight Lifting Exercises (WLE) Dataset <http://groupware.les.inf.puc-rio.br/har>. Predictive data consisted of activity measurements obtained from four different wearable devices.
